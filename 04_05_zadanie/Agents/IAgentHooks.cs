...
/// a refusal returned before a tool call saves a request the rate limit makes expensive, and a demand
/// returned before the agent finishes keeps it working until a route has actually been delivered.
/// </summary>
