...
/// stop. Calls run one after another rather than concurrently: the hub's endpoints close for about a
/// minute after a burst, so a turn full of parallel calls buys nothing and costs the rate limit.
/// </summary>
